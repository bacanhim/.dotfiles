...
paru -S auto-cpufreq visual-studio-code-bin chili-sddm-theme betterlockscreen-git oh-my-zsh-git zsh-theme-powerlevel10k-git zsh-syntax-highlighting-git zsh-autosuggestions-git ttf-font-awesome-5 --noconfirm
