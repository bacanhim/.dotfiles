...
arch-chroot /mnt pacman -S alacritty perl-json-xs perl-anyevent-i3 pacman-contrib python-dbus dunst rofi i3-gaps neofetch stow playerctl capitaine-cursors ttf-font-awesome flameshot thunar feh zsh code firefox teamspeak3 materia-gtk-theme papirus-icon-theme --noconfirm
sleep 15
clear
echo "ROOT PASSWORD"
