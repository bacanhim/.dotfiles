...
arch-chroot /mnt runuser -l bacanhim -c 'paru -S chili-sddm-theme betterlockscreen-git timeshift timeshift-autosnap spotify-tui oh-my-zsh-git zsh-theme-powerlevel10k-git zsh-syntax-highlighting-git zsh-autosuggestions-git --noconfirm'
